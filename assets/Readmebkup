...
Remote deployment & SSH tunneling
...
□ Reverse-engineering Android framework internals
□ Building offline-first tooling for constrained environments
□ Contributing to open-source system utilities
...
Resource	Description	
[Harvard CS50x](https://cs50.harvard.edu/x/)	The gold standard for free CS education.	
[freeCodeCamp Full Curriculum](https://www.freecodecamp.org/learn/)	Thousands of hours of free coding curriculum + certifications.	
[Exercism](https://exercism.org/)	Free coding practice with human mentor feedback across 60+ languages.	
[The Odin Project](https://www.theodinproject.com/)	Full-stack open-source curriculum built for self-teachers.	


Thanks for reading...  

Update in progress as always. ⭐
